# Taiwan Post Tracking API For Ruby
Taiwan Post Tracking API and webhook make it easy to integrate Taiwan Post Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a Taiwan Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Taiwan Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Taiwan Post Tracking API](https://www.trackingmore.com/taiwan-post-tracking.html)  to:

   *   Get Taiwan Post realtime tracking info of muti-carriers in one integration
   *   Provide Taiwan Post shipment tracking experience like Amazon
   *   Push Taiwan Post notifications of package update with webhook
   *   Verify Taiwan Post delivery exception before it is too late
